...
public class TalksByConferenceAndDay extends State {
	private Form form = new Form();
	private Table table = new Table();
	
	public TalksByConferenceAndDay(StateManager stateManager) {
		super(stateManager);
	}
	...
	private void buildTable() {
		...
		VDMSet talks = sm.ws.GetConferenceTalksOfDay(conf, date);
	...
	public void onEnter() {
		form = new Form();
		form.addField("Conf", "In which conference should the talks be taking place?", Type.STRING);
	...
	public void display() {
		Term.clear();
		Term.println("* Main Menu > Schedule > Talks > Talks By Conference And Day");
