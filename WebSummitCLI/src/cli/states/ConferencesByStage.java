...
public class ConferencesByStage extends State {
	private Form form = new Form();
	private Table table = new Table();
	
	public ConferencesByStage(StateManager stateManager) {
		super(stateManager);
	}
	...
	private void buildTable() {
		...
		VDMSet conferences = sm.ws.GetConferencesInStage(stage);
	...
	public void onEnter() {
		form = new Form();
		form.addField("Stage", "In what stage should the conferences happen?", Type.STRING);
	}
	...
	public void display() {
		Term.clear();
		Term.println("* Main Menu > Schedule > Conferences > Conferences By Stage");
